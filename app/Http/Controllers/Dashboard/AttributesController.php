...
use App\Http\Requests\UniqueAttributeRequest;
...
class AttributesController extends Controller
{
    ...
    public function store(UniqueAttributeRequest $request)
    {
    ...
    public function update($id, UniqueAttributeRequest $request)
    {
        try {
            //validation
