            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('admin.products.general.create')}}"
                        ...
                        data-i18n="nav.dash.crypto">أضافة منتج جديد  </a>
                    </li>
                </ul>
            </li>
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{__('admin/sidebar.shipping methods')}}</a>
                        <ul class="menu-content">
                            ...
                            <li><a class="menu-item" href="{{route('edit.shippings.methods','local')}}">{{__('admin/sidebar.local shipping')}}</a>
                            </li>
                            ...
                            <li><a class="menu-item" href="#"
                                   data-i18n="nav.templates.vert.main">السلايدر الرئيسية </a>
                                <ul class="menu-content">
                                    <li><a class="menu-item" href="{{route('admin.sliders.create')}}"
                                           data-i18n="nav.templates.vert.classic_menu">صور السلايدر </a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
