                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.maincategories')}}"> المنتجات </a>
                                </li>
                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> الإسم بالرابط
                                                            </label>
                                                            <input type="text" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projecting">إختر القسم
                                                            </label>
                                                            <select name="categories[]" class="select2 form-control"
                                                                    multiple>
                                                                <optgroup label="من فضلك إختر القسم">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projecting">إختر العلامات الدلالية
                                                            </label>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projecting">إختر الماركة
                                                            </label>
                                                            <select name="brands" class="select2 form-control">
                                                                <optgroup label="إختر الماركة">
