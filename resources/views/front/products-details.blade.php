                                                        ...
                                                        @foreach($product -> images as $image)
                                                            <div class="item thumb-container col-md-6 col-xs-12 pt-30">
                                                                <img class="img-fluid thumb js-thumb  selected "
                                                                     data-image-medium-src="{{asset('assets/images/products/'.$image -> photo)}}"
                                                                     data-image-large-src="{{asset('assets/images/products/'.$image -> photo)}}"
                                                            ...
                                                            <a href="{{route('product.details',$_product -> slug)}}"
                                                               class="thumbnail product-thumbnail two-image">
                                                                <img class="img-fluid image-cover"
                                                                     src="{{asset('assets/images/products/'.$_product -> images[0] -> photo ?? '')}}"
                                                                     alt=""
